...
// DHP256 is the P256 ECDH function

var DH256 DHFunc = dhp256{}

type dhp256 struct{}

func (dhp256) GenerateKeypair(rng io.Reader) (DHKey, error) {
	...
	return DHKey{Private: priv.D.Bytes(), Public: x509EncodedPub}, nil
}

func (dhp256) DH(privkey, pubkey []byte) ([]byte, error) {
	...
	a, _ := pub.(*ecdsa.PublicKey).Curve.ScalarMult(pub.(*ecdsa.PublicKey).X, pub.(*ecdsa.PublicKey).Y, privkey)
...
func (dhp256) DHLen() int     { return 32 }
func (dhp256) DHName() string { return "256" }
